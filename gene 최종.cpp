...
#define SURV_GENE 7					//3~8
#define MUTANT_POS 15					//4~15
#define GET_MAX 100						//모터, 시간 최댓값 
#define GET_MIN 30						//모터, 시간 최솟값 

void get_start_gene();					//처음 세대의 유전자 생성
int *get_gene();
int *get_sol();
int *get_feedback(int *, int *);		// 
int *study(int*, int*);
int *tmp;
